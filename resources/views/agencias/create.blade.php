    ...
    <div class="container mx-auto mt-8">
        ...
        <form action="{{ route('agencias.store') }}" method="POST" class="container mx-auto mt-8">
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div>
                    <label for="codigo_agencia" class="block text-gray-700 text-sm font-bold mb-2">Codigo de
                        Agencia:</label>
                ...
                <div>
                    <label for="pais" class="block text-gray-700 text-sm font-bold mb-2">Pais:</label>
                ...
                <div>
                    <label for="porcentaje_descuento" class="block text-gray-700 text-sm font-bold mb-2">Porcentaje de
                        Descuento:</label>
            ...
            <div class="flex items-center">
                <button type="submit"
                    class="bg-blue-500 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline-blue active:bg-blue-800">Guardar</button>
            </div>
        </form>
    </div>
@endsection
