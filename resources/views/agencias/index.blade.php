        ...
        <table class="min-w-full bg-white border border-gray-300" style="margin-top: 20px">
            <thead>
                <tr>
                    ...
                    <th class="py-2 px-4 border-b">Monto de Pago</th>
                    <th class="py-2 px-4 border-b">Tipo de Pago</th>
                    <th class="py-2 px-4 border-b">Vendedor</th>
                    <th class="py-2 px-4 border-b">Porcentaje de Descuento</th>
            ...
            <tbody>
                @foreach ($agencias as $agencia)
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b">{{$agencia->nombre_cliente}}</td>
                        <td class="py-2 px-4 border-b">{{$agencia->email}}</td>
                        <td class="py-2 px-4 border-b">{{$agencia->agency}}</td>
                        <td class="py-2 px-4 border-b">{{$agencia->fecha_compra}}</td>
                        <td class="py-2 px-4 border-b">{{$agencia->modalidad}}</td>
                        <td class="py-2 px-4 border-b">{{$agencia->monto_pago}}</td>
                        <td class="py-2 px-4 border-b">{{$agencia->tipo_pago}}</td>
                        <td class="py-2 px-4 border-b">{{$agencia->vendedor}}</td>
                        <td class="py-2 px-4 border-b">{{$agencia->porcentaje_descuento}}</td>
